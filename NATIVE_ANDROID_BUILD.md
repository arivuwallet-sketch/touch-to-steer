...
The project uses Flutter's current AGP 9 build path with AndroidX and compile/target SDK 36. Android 17/API 37 is still in beta, so the production build targets stable Android 16/API 36.
